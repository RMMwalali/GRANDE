...
const Plan = styled.div`
  ${tw`w-full max-w-sm mt-16 lg:mr-8 lg:last:mr-0 text-center px-8 rounded-lg shadow relative pt-2 text-black bg-white flex flex-col`}
  .planHighlight {
...
export default ({
  ...
  description = "Save time, effort and money from our affordable pricing and exquisite services.",
  plans = null,
  ...
  const defaultPlans = [
    {
      name: "NFT website",
      price: "$299.99",
      mainFeature: "NFT minting",
      features: ["Landing page", "NFT marketplace", "NFT minting website ", "Basic Assistance"],
    },
    {
      name: "Website Development",
      price: "$199.99",
      mainFeature: "Portfolios, E-Commerce, Blogs and Admin Sites",
      features: ["Landing Page", "Custom Build", "Basic Assistance"],
      featured: true,
    },
    {
      name: "Graphics and Design",
      price: "$99.99",
      mainFeature: "Logos, Business Cards, NFT art, Website and App Design",
      features: ["Different Requests", "Different traits", "Price varies"],
    },
  ];
