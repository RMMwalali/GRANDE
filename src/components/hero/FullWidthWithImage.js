...
const Heading = tw.h1`text-3xl sm:text-5xl md:text-6xl lg:text-5xl text-black font-bold leading-none`;
const Paragraph = tw.p`max-w-md my-8 lg:my-5 lg:my-8 sm:text-lg text-black font-semibold lg:text-base xl:text-lg leading-loose`;
...
const Actions = styled.div`
  ...
  .secondaryAction {
    ${tw`mt-4 sm:mt-0 sm:ml-4 bg-gray-300 text-black hover:bg-gray-400 hover:text-black`}
  }
`;
...
export default ({
  ...
  heading = (
    <>
      ...
      <wbr />
      <br />
      <span tw="text-primary-500">By Professionals</span>
    </>
  ),
  description = "We've been in the business across the world for 5 years now. We assure you that you will always receive quality work.",
  primaryActionUrl = "#",
